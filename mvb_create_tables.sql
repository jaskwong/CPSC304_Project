...
insert into vehicles values('28235', 'Honda', 'small', 2018, 'green', 10000, 'A', 'Sedan', 'West', 'Vancouver');
...
insert into vehicles values('28211', 'Chevrolet', 'small', 2018, 'black', 10000, 'A', 'Convertible', 'West', 'Vancouver');
insert into vehicles values('28111', 'Honda', 'middle', 2018, 'green', 10000, 'M', 'SUV', 'West', 'Vancouver');
insert into vehicles values('28222', 'Benz', 'middle', 2018, 'red', 10000, 'A', 'SUV', 'West', 'Vancouver');
insert into vehicles values('28333', 'BMW', 'small', 2018, 'black', 10000, 'A', 'Sedan', 'West', 'Vancouver');
insert into vehicles values('28444', 'BMW', 'small', 2018, 'red', 10000, 'A', 'Sedan', 'West', 'Vancouver');
...
insert into vehicles values('21111', 'Chevrolet', 'large', 2018, 'green', 10000, 'A', 'SUV', 'West', 'Vancouver');
...
insert into vehicles values('90231', 'Chevrolet', 'large', 2018, 'green', 29000, 'A', 'SUV', 'East', 'Vancouver');
